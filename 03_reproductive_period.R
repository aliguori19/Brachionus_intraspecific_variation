...
tiff("rep_period.tiff", units="in", width=7, height=12, res=1200)
...
annotate_figure(rep_curves, left = textGrob("Reproductive period (% of lifespan)", rot = 90, gp = gpar(fontsize = 20, fontface = 'bold')))
