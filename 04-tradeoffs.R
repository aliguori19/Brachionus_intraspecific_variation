...
# Models for each maternal age:
tradeoff_repd_L5_Y <- filter(tradeoff_repd_L5, maternal_age == "young")
tradeoff_repd_L5_M <- filter(tradeoff_repd_L5, maternal_age == "mid")
tradeoff_repd_L5_O <- filter(tradeoff_repd_L5, maternal_age == "old")

lm_repd_L5_Y <- lm(rep_time ~ surv_time, data = tradeoff_repd_L5_Y)
summary(lm_repd_L5_Y)
lm_repd_L5_M <- lm(rep_time ~ surv_time, data = tradeoff_repd_L5_M)
summary(lm_repd_L5_M)
lm_repd_L5_O <- lm(rep_time ~ surv_time, data = tradeoff_repd_L5_O)
summary(lm_repd_L5_O)
...
# Models for each maternal age:
tradeoff_repd_RUS_Y <- filter(tradeoff_repd_RUS, maternal_age == "young")
tradeoff_repd_RUS_O <- filter(tradeoff_repd_RUS, maternal_age == "old")

lm_repd_RUS_Y <- lm(rep_time ~ surv_time, data = tradeoff_repd_RUS_Y)
summary(lm_repd_RUS_Y)
lm_repd_RUS_O <- lm(rep_time ~ surv_time, data = tradeoff_repd_RUS_O)
summary(lm_repd_RUS_O)
...
# Models for each maternal age:
tradeoff_repd_RUS_RE_Y <- filter(tradeoff_repd_RUS_RE, maternal_age == "young")
tradeoff_repd_RUS_RE_M <- filter(tradeoff_repd_RUS_RE, maternal_age == "mid")
tradeoff_repd_RUS_RE_O <- filter(tradeoff_repd_RUS_RE, maternal_age == "old")

lm_repd_RUS_RE_Y <- lm(rep_time ~ surv_time, data = tradeoff_repd_RUS_RE_Y)
summary(lm_repd_RUS_RE_Y)
lm_repd_RUS_RE_M <- lm(rep_time ~ surv_time, data = tradeoff_repd_RUS_RE_M)
summary(lm_repd_RUS_RE_M)
lm_repd_RUS_RE_O <- lm(rep_time ~ surv_time, data = tradeoff_repd_RUS_RE_O)
summary(lm_repd_RUS_RE_O)
...
# Models for each maternal age:
tradeoff_repd_BpL1_Y <- filter(tradeoff_repd_BpL1, maternal_age == "young")
tradeoff_repd_BpL1_M <- filter(tradeoff_repd_BpL1, maternal_age == "mid")
tradeoff_repd_BpL1_O <- filter(tradeoff_repd_BpL1, maternal_age == "old")

lm_repd_BpL1_Y <- lm(rep_time ~ surv_time, data = tradeoff_repd_BpL1_Y)
summary(lm_repd_BpL1_Y)
lm_repd_BpL1_M <- lm(rep_time ~ surv_time, data = tradeoff_repd_BpL1_M)
summary(lm_repd_BpL1_M)
lm_repd_BpL1_O <- lm(rep_time ~ surv_time, data = tradeoff_repd_BpL1_O)
summary(lm_repd_BpL1_O)
...
RPD <- annotate_figure(RPD, left = textGrob("Reproductive period (d)", 
                                            rot = 90, gp = gpar(fontsize = 24)))
RPD
