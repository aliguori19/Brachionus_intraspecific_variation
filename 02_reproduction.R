...
RO_curves <- annotate_figure(RO_curves, left = textGrob("Offspring per mother", rot = 90, gp = gpar(fontsize = 20, fontface = 'bold')))
...
LRO_summary <- annotate_figure(LRO_summary, left = textGrob("Lifetime reproductive output", rot = 90, gp = gpar(fontsize = 20, fontface = 'bold')))
